...
class WeightsDownloader:
    ...
    def download_weights(self, weight_str):
        if weight_str in self.weights_map:
            ...
            print(f"⚠️  skipping downloading {weight_str} as it's not found in supported list. View the list of available weights: https://github.com/fofr/cog-comfyui/blob/main/supported_weights.md")
